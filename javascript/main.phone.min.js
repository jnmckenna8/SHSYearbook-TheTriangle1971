...
this.setSrc(this.goButton,"goPage");this.inputButton=$("<div class='inputButton' style='width:190px;'>\n        <label>\n          <input aria-labelledby='currentPageIndex' id='currentPageIndexTextField' enterkeyhint=\"go\" type='text'/>\n        </label>\n      </div>");bookConfig.enablePageBack&&this.inputButton.css({width:"100px"});bookConfig.enablePageBack&&this.contentBox.append(this.backwardButton);void 0!==bookConfig.isMobileFirstLastShortcutVisible?bookConfig.isMobileFirstLastShortcutVisible&&
this.contentBox.append(this.firstButton):this.contentBox.append(this.firstButton);this.contentBox.append(this.prevButton);this.contentBox.append(this.inputButton);this.contentBox.append(this.nextButton);void 0!==bookConfig.isMobileFirstLastShortcutVisible?bookConfig.isMobileFirstLastShortcutVisible&&this.contentBox.append(this.lastButton):this.contentBox.append(this.lastButton);bookConfig.enablePageBack&&this.contentBox.append(this.forwardButton);tmpContainer.append(this.pagePrevButton);tmpContainer.append(this.pageNextButton);
if(bookConfig.FlipDirection){this.pagePrevButton.css({position:"absolute",top:"40px",left:"50%","z-index":"110",transform:"translate(-50%,0)"});this.pageNextButton.css({position:"absolute",bottom:"40px",left:"50%","z-index":"110",transform:"translate(-50%,0)"});var a={width:"56px",height:"36px"};switch(bookConfig.phoneFlipShortcutButtonSize){case "small":a={width:"56px",height:"36px"};break;case "normal":a={width:"66px",height:"56px"};break;case "large":a={width:"76px",height:"76px"}}}else switch(this.pagePrevButton.css({position:"absolute",
top:"50%",left:"0","z-index":"11",transform:"translate(0%,-50%)"}),this.pageNextButton.css({position:"absolute",top:"50%",right:"0","z-index":"11",transform:"translate(0%,-50%)"}),a={width:"36px",height:"56px"},bookConfig.phoneFlipShortcutButtonSize){case "small":a={width:"36px",height:"56px"};break;case "normal":a={width:"56px",height:"76px"};break;case "large":a={width:"76px",height:"96px"}}this.pagePrevButton.css(a);this.pageNextButton.css(a);this.inputButton.find("input").css({padding:"0px","text-align":"center",
"border-width":"0px",background:"rgba(255,255,255,0.7)",width:"100%",height:"30px","border-radius":"15px",position:"absolute",color:bookConfig.pageNumColor,left:0,top:0});(isPhone()||isPad())&&this.inputButton.find("input").css({})},initSlider:function(){this.onStepLength=(windowWidth-80)/bookConfig.totalPageCount;this.slider=$("<div style='position:absolute;cursor:pointer;left:40px;top:65px;width:"+(windowWidth-80)+"px;height:4px;background:"+this.iconColor.rgba(.3)+";border-radius: 2px;'></div>");
this.sliderEnter=$("<div style='position:absolute;"+this.direction+":0;top:0;width:0px;height:4px;background:"+this.iconColor.toString()+";border-radius: 2px;'></div>");this.pointer=$("<div style='cursor:pointer;position:absolute;"+this.direction+":12px;top:-10px;width:20px;height:20px;border-radius: 50%;padding:2px;'><div style='pointer-events: none;border:3px solid "+this.iconColor.toString()+";width:14px;height:14px;border-radius: 50%;background: "+this.mainColor.toString()+";'></div></div>");
this.slider.append(this.sliderEnter).append(this.pointer);this.menu.append(this.slider);this.initSliderEvent()},initSliderEvent:function(){this.slider.onTap(function(a){if(a.srcEvent){var b=rightToLeft?windowWidth-a.srcEvent.pageX:a.srcEvent.pageX;bookConfig.upsideOnMobile()&&(b=rightToLeft?windowWidth-a.srcEvent.pageY:a.srcEvent.pageY)}else b=rightToLeft?windowWidth-a.pageX:a.pageX,bookConfig.upsideOnMobile()&&(b=rightToLeft?windowWidth-a.pageY:a.pageY);this.endLeft=b-51;this.endLeft=-11>this.endLeft?
-11:this.endLeft>windowWidth-91?windowWidth-91:this.endLeft;gotoPageFun(this.getSlideIndex(this.endLeft),!1,"phone goto slider")}.bind(this));this.pointer.bind(_event._down,function(a){this.isTouchDown=!0}.bind(this));this.slider.bind(_event._down,function(a){this.startPos=this.getPosition(a);40>=this.startPos.x&&(this.startPos.x=40);this.startPos.x>=windowWidth-40&&(this.startPos.x=windowWidth-40)}.bind(this));this.menu.bind(_event._move,function(a){if(this.isTouchDown){this.endPos=this.getPosition(a);
40>=this.endPos.x&&(this.endPos.x=40);this.endPos.x>=windowWidth-40&&(this.endPos.x=windowWidth-40);var b=this.endPos.x-this.startPos.x;this.endLeft=rightToLeft?this.pointer.right()-b:this.pointer.left()+b;this.endLeft=-11>this.endLeft?-11:this.endLeft>windowWidth-91?windowWidth-91:this.endLeft;1.01<Math.abs((this.endPos.x-this.startPos.x)/(this.endPos.y-this.startPos.y))&&a.preventDefault();a=this.getSlideIndex(this.endLeft);$("#currentPageIndexTextField").val(this.getPageNumberInfo(a));a={};this.pointer.css((a[this.direction]=
this.endLeft+"px",a));this.sliderEnter.css({width:(rightToLeft?windowWidth-this.endPos.x-38:this.endPos.x-38)+"px"});this.startPos=this.endPos}}.bind(this));this.menu.bind(_event._end,function(a){this.isTouchDown&&(this.isTouchDown=!1,this.endLeft&&this.endPos&&(gotoPageFun(this.getSlideIndex(this.endLeft),!1,"phone goto slider"),a={},this.pointer.css((a[this.direction]=this.endLeft+"px",a)),this.sliderEnter.css({width:this.endPos.x-38+"px"})))}.bind(this))},onResize:function(){this.onStepLength=
(windowWidth-80)/bookConfig.totalPageCount;this.slider.css({width:windowWidth-80+"px"});this.refreshSlider();this.refreshInputSize()},getSlideIndex:function(a){a=Math.ceil((a+11)/this.onStepLength);a>=bookConfig.totalPageCount&&(a=bookConfig.totalPageCount);1>=a&&(a=1);return a},refreshSlider:function(){if(this.isBetweenPagesPos()){var a={};this.pointer.animate((a[this.direction]=this.endLeft+"px",a));this.sliderEnter.animate({width:this.endLeft+4+"px"})}else if(a=-11+this.onStepLength*BookInfo.getCurrentPageIndex(),
1==BookInfo.getCurrentPageIndex())a={},this.pointer.animate((a[this.direction]="-11px",a)),this.sliderEnter.animate({width:"0px"});else{BookInfo.getCurrentPageIndex()==bookConfig.totalPageCount&&(a=windowWidth-91);var b={};this.pointer.animate((b[this.direction]=a+"px",b));this.sliderEnter.animate({width:a+4+"px"})}},refreshInputSize:function(){var a=60>windowWidth-160+3?60:windowWidth-160+3;bookConfig.enablePageBack?this.inputButton.css({"max-width":(60>a-80?60:a-80)+"px"}):this.inputButton.css({"max-width":a+
"px"})},isBetweenPagesPos:function(){if(!this.endLeft)return!1;var a=BookInfo.getBook().getCurrentPages();if(1==a.length){if(this.endLeft<=-11+a[0]*this.onStepLength&&this.endLeft>=-11+(a[0]-1)*this.onStepLength)return!0}else if(this.endLeft>=-11+(a[0]-1)*this.onStepLength&&this.endLeft<=-11+a[1]*this.onStepLength)return!0;return!1},getPageNumberInfo:function(a){return rightToLeft?bookConfig.totalPageCount+"/"+a:a+"/"+bookConfig.totalPageCount},getPosition:function(a){a=a.originalEvent&&a.originalEvent.changedTouches?
a.originalEvent.changedTouches:a.changedTouches?a.changedTouches:[a];var b=(a[0].pageX||a[0].clientX)+(document.documentElement.scrollLeft||document.body.scrollLeft);a=(a[0].pageY||a[0].clientY)+(document.documentElement.scrollTop||document.body.scrollTop);return bookConfig.upsideOnMobile()?{x:a,y:b}:{x:b,y:a}},resetPosition:function(){this.contentBox.html("");this.initContentBox();this.initEvent()},setSrc:function(a,b,c){var d=a.find("img");a=a.find(".svg-box");c&&""!=c?(d.attr("src",c),a.css({display:"none"})):
phoneSvgIcons&&phoneSvgIcons[b]&&(a.html(phoneSvgIcons[b]),d.css({display:"none"}));this.colorChanged=!1},changeCaptionColor:function(a){if(this.fontColor||a)a||(a=this.fontColor.toString()),this.$caption&&this.$caption.css("color",a)},showPageFlipButton:function(){bookConfig.showInstructionOnStart&&1==BookInfo.getCurrentPageIndex()||(this.pageFlipVisible=!0,this.pagePrevButton.fadeIn(200),this.pageNextButton.fadeIn(200))},hidePageFlipButton:function(){this.pageFlipVisible=!1;this.pagePrevButton.fadeOut(200);
this.pageNextButton.fadeOut(200)},show:function(){this.refreshSlider();toolBar.extendedBar&&toolBar.extendedBar.visible&&toolBar.extendedBar.hide();var a=toolBar.getBottomHeight(!0);this.menu.animate({bottom:a},300);this.visible=!0},hide:function(){this.menu.animate({bottom:-140},300);this.visible=!1},showOrHide:function(){!0===this.visible?this.hide():this.show()},initEvent:function(){this.firstButton.onTap(function(){BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"first",getLanguage("btnFirstPage",
"First")]);rightToLeft?lastPageFun("phone goto button"):firstPageFun("phone goto button");return!1});this.prevButton.onTap(function(){rightToLeft?nextPageFun("phone goto button"):previousPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"prev",getLanguage("btnPrePage","Previous")]);return!1});this.nextButton.onTap(function(){rightToLeft?previousPageFun("phone goto button"):nextPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),
